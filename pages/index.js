  ...
  return (
    <>
      ...
      <div className="mx-auto mt-10 max-w-6xl text-center sm:mt-32">
        ...
        <div className="mt-6 flex flex-col items-center gap-4 sm:flex-row sm:gap-6">
          <Link
            ...
            href="/auth/signin" // Replace with the actual appointment page URL
          >
          ...
          <Link
            ...
            href="/signup" // Replace with the actual services page URL
          >
      ...
      <div className='mx-auto h-screen mt-32 max-w-5xl sm:mt-56'>
        ...
        {/* Department List (Replace with actual departments) */}
